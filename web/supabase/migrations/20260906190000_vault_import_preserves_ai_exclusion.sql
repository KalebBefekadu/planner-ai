-- Restoring a vault must not quietly return a Note to AI retrieval. Export
-- records AI Exclusion per Note, but the import dropped it and every restored
-- Note was created included. Carry the flag through staging to the Note.
  ...
  if p_operation_id = 'note.import-preview.v1' then
    ...
    loop
      ...
      insert into public.notes (
        ...
        1000 + v_item.sort_order, v_item.ai_excluded
