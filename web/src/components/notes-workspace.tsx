...
export function NotesWorkspace({
  ...
  function toggleFavorite() {
    ...
    startTransition(async () => {
      try {
        const saved = await setNoteFavorite(selected.id, next, versionRef.current);
  ...
  // pages apart. Whatever of the ancestor chain is present in the results is
  // shown underneath the title, so "Notes" under Acme and "Notes" under Globex
  // are distinguishable before the click rather than after it.
    ...
    <div className="notes-shell">
      <aside className="notes-sidebar">
        ...
        {favoriteNotes.length ? (
          <nav className="note-favorites" aria-label="Favourite Notes">
            <h2 className="note-favorites-heading">Favourites</h2>
            <ul className="note-tree-level">
