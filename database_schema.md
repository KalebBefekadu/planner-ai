...
Status: **Approved logical model.** Physical SQL is delivered through reviewed Supabase migrations. The file `database/schema.sql` is a legacy prototype snapshot and is not the target schema.
