const messages = {
  ...
  chat: {
    ...
    archiveFailed: "보관 실패",
    chats: "채팅",
    composerPlaceholder: "이번 주 이야기하기…",
    emptyState: "이번 주 이야기하기",
    heroDescription: "편하게 이야기하세요. 계획은 제가 정리할게요.",
    heroTitle: "이번 주는 어땠나요?",
    ...
    suggestionActions: "목표 추가",
    suggestionCapabilities: "이번 주 기록하기",
    suggestionCustomize: "어디서 벗어나고 있나요?",
    unpinChat: "채팅 고정 해제",
  },
  navigation: {
    chat: "채팅",
