const messages = {
  ...
  chat: {
    ...
    chats: "Chats",
    composerPlaceholder: "Conte sua semana…",
    emptyState: "Conte sua semana",
    heroDescription: "Fale à vontade. Eu mantenho o plano em ordem.",
    heroTitle: "O que aconteceu esta semana?",
    ...
    suggestionActions: "Adicionar uma meta",
    suggestionCapabilities: "Registrar minha semana",
    suggestionCustomize: "Onde estou me desviando?",
