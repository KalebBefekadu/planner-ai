...
| Canonical migrations and pgTAP           | Partial | Migration history and guarded preflight aligned through `20260906114500` after a fresh encrypted backup; local pgTAP passes, while deployed canonical journeys remain to be verified                         |
