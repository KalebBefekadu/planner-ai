...
| ---------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Remote database backup and restore       | Partial | Encrypted logical backup and local isolated Supabase restore passed on 2026-09-05: 8 public tables, all 8 with RLS, and 5 public functions; off-machine custody and hosted recovery-project drill remain open |
| Private Storage backup and restore       | Pending | Attachment infrastructure not enabled                                                                                                                                                                         |
| Canonical migrations and pgTAP           | Partial | Canonical production schema applied through `20260904172530`; 53 of 53 public tables use RLS, local pgTAP passes 895 assertions, and deployed canonical journeys remain to be verified                        |
