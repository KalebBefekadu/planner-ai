...
- The canonical authenticated Playwright corpus passes 118 desktop and mobile tests, including Capture, Planner, Calendar scheduling, Today, authenticated accessibility, auth-boundary, and assistant-outage journeys.
